    ...
    <div className="container">
      <div className="row justify-content-center">
        ...
        <div className="col-12">
          <h2 id="past-undergraduate-and-mscac-students">Past Undergraduate and MScAC Students</h2>
          <ul>
            <li>
              <a href="https://kanavsinglaa.github.io/" target="_blank" rel="noopener">
                Kanav Singla
              </a>{' '}
              (EngSci, 2022 - 2024)
            </li>
            ...
            <li>
              <a href="https://tianshukuai.github.io/" target="_blank" rel="noopener">
                Tianshu Kuai
              </a>{' '}
              (MScAC, 2022 - 2023, next position: PhD@Montréal)
            </li>
            <li>Guanyu Song (2022 - 2024, next position: Software Eng.@WeRide)</li>
            ...
            <li>Xudong Liu (MScAC, 2022 - 2023, next position: ML Eng.@TikTok)</li>
            <li>Jiachen Xu (2023)</li>
            <li>Solomon Asad (2023)</li>
            <li>Kajanan Chinniah (EngSci, 2022-2023, next position: Robotics Eng.@NVIDIA)</li>
            ...
            <li>Andrei Ivanovic (EngSci, 2021-2022, next position: UofT CS MSc.)</li>
            <li>Yihan “Nick” Ni (EngSci, 2021-2022)</li>
          </ul>

          <h2 id="past-visitors">Past Visitors</h2>
          <ul>
            ...
            <li>Dr.-Ing. Ömer&nbsp;Şahin&nbsp;Taş&nbsp;(KIT, Visiting Graduate Student, 2022)</li>
            <li>
              Felix Taubner (ETH, Master Thesis, 2021-2022, Next Position: AI Research Scientist, LG Electronics)
            </li>
          </ul>
        </div>
      </div>
